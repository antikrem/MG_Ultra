...
void registerGlobalFunctions(kaguya::State &kaguya) {
	...
	kaguya["setParticleTypeVelocityRotation"] = g_particles::updateVelocityRotation;
	kaguya["setParticleTypeFeatherness"] = g_particles::updateFeatherness;
	kaguya["setParticleTypeScrollness"] = g_particles::updateScrollness;
	...
	kaguya["setGreyScaleFactorTarget"] = g_graphicsSettings::setGreyScaleFactorTarget;
	kaguya["setGreyScaleFactorRate"] = g_graphicsSettings::setGreyScaleFactorRate;
	kaguya["setGreyScaleFactor"] = g_graphicsSettings::setGreyScaleFactor;
